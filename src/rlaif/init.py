...
def run() -> int:
    ...
    if do_negative:
        ...
        print("     negative(1, 1) is refused with a `negative.safety.allow` error.")
        ...
        print("  3. fire 4 back-to-back negative(1,1) calls; confirm the 4th")
    ...
    if do_positive:
        ...
        print("     and positive(1, 1) is refused with `positive.safety.allow`.")
